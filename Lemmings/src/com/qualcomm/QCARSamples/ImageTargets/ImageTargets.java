...
public class ImageTargets extends Activity
{
    ...
    {        
        mTextures.add(Texture.loadTextureFromApk("default_sphere.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("checker_sphere.png", getAssets())); 
        mTextures.add(Texture.loadTextureFromApk("eyeball_sphere.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("glow_sphere.png", getAssets()));        
    }
                ...
                mSplashScreenRunnable =
                    new Runnable() {
                        public void run()
                        {
                            ...
                            //add the hud
                            hudText.setText("Move the glowing orb to guide your Lemmings to Safety!");
                            addContentView(hudText, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
                        }
                };
